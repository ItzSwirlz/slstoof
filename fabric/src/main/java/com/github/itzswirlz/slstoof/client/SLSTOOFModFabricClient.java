...
public class SLSTOOFModFabricClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		ParticleFactoryRegistry.getInstance().register(SLSTOOFParticles.COPPER_FIRE_FLAME.get(), FlameParticle.Factory::new);
		ParticleFactoryRegistry.getInstance().register(SLSTOOFParticles.IRON_FIRE_FLAME.get(), FlameParticle.Factory::new);
